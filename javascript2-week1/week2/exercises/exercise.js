...
const cheapListings = listings.filter(listing => listing.price <= 3000);
console.log("cheapListings", cheapListings);

const expensiveListingPrices = listings
  .filter(listing => listing.price > 7000)
  .map(listing => listing.price);
console.log("Expensive Listing Prices:", expensiveListingPrices);

const listingsWithParking = listings.filter(listing => listing.facilities.includes('Parkering'));
console.log("Listings with Parking:", listingsWithParking);
